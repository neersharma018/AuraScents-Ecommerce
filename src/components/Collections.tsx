  ...
  return (
    <section className="py-32 relative bg-[var(--bg-ivory)]" id="collections">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          <div className="eyebrow justify-center mb-6">Curated For You</div>
            ...
            {categories.map((category) => (
              <div key={category.id} className="relative">
                <div className="flex justify-between items-end mb-8 border-b border-[var(--border-dark)] pb-4">
                  <div>
                    <h3 className="serif text-4xl text-[var(--text-main)] mb-2">{category.name}</h3>
                    ...
                    {category.products.map((p: any, i: number) => (
                      ...
                      >
                        ...
                        <div className="text-center">
                          <h4 className="serif text-2xl text-[var(--text-main)] group-hover:text-[var(--gold)] transition-colors">{p.name}</h4>
